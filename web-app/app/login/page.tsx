...
function LoginPageContent() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background p-4 sm:p-6 lg:p-8 selection:bg-tertiary selection:text-primary">
      ...
      <div className="pointer-events-none absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-tertiary/10 blur-3xl" />
      ...
      <div className="relative grid w-full max-w-5xl animate-fadein overflow-hidden rounded-3xl border border-border bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-16px_rgba(15,23,42,0.10)] lg:grid-cols-2">
        ...
        <section className="relative overflow-hidden bg-primary p-8 sm:p-12 lg:p-14">
          <div
          ...
          ></div>
          <div className="pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full bg-tertiary/10 blur-3xl"></div>
          <div className="pointer-events-none absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-white/10 blur-3xl"></div>
        ...
        <section className="flex flex-col justify-center bg-white p-8 sm:p-12 lg:p-14">
          ...
          <div className="mb-8 text-center lg:text-left">
            ...
            <p className="mt-1.5 text-sm text-secondary-foreground">
              Access your official administrative workspace.
            </p>
          </div>

          {/* ERROR ALERT */}
          {error && (
            <div className="mb-6 flex animate-fadein items-start gap-3 rounded-xl border border-danger/30 bg-danger/10 p-4">
              <CircleAlert className="mt-0.5 h-5 w-5 shrink-0 text-danger" />
              <p className="text-sm font-medium leading-snug text-danger">
                {error}
              </p>
            </div>
          )}
          ...
          <p className="mt-5 text-center text-xs text-secondary-foreground">
            Authorized personnel only. Sign-in uses your official Google
            account.
          </p>
