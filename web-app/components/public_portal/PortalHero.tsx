export default function PortalHero() {
  return (
    <section className="pt-10 pb-10 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 pb-8 border-b border-border">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-primary-foreground tracking-tight leading-[1.05]">
              Public Expenditure
              <br />
              <span className="text-primary">Dashboard</span>
            </h1>
          </div>
          <p className="text-secondary-foreground text-sm leading-relaxed max-w-sm md:text-right">
